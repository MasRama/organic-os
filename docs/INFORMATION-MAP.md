...
| Audit-dimension list (page essentials: the seven checks and their signal severities) | numbered dimension in `plugin/skills/onsite-audit/SKILL.md` (step 3) | `plugin/skills/hoo-monthly-audit/SKILL.md` site-wide step; `docs/adr/0010-audit-dimension-responsibility.md` | manual |
