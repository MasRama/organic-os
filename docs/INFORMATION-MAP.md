...
| CMS adapter contract (`CmsAdapter` surface, `adapter_for`, supported types, `cms:` profile key) | `plugin/lib/onsite/cms.py` | `plugin/docs/site-repo-contract.md` cms key bullet; `CONTRIBUTING.md` adapter section; `ROADMAP.md` v0.3 | manual |
